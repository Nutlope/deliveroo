...
const features = [
  ...
  {
    name: 'Re-order your usual meals',
    description:
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        ...
        <AppScreen.Subtitle>
          Get <span className="text-white">$10</span> for every invite.
        </AppScreen.Subtitle>
      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
          <div className="space-y-6">
            {[
              { label: 'Full name', value: 'Omar El Mghari' },
              { label: 'Email address', value: 'omar@bearingpoint.com' },
            ].map((field) => (
              <div key={field.label}>
...
function StocksScreen({ custom, animated = false }) {
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreen.Title>Previous Orders</AppScreen.Title>
        <AppScreen.Subtitle>September 18, 2022</AppScreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
...
function InvestScreen({ custom, animated = false }) {
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreen.Title>Usual Panera Order</AppScreen.Title>
        <AppScreen.Subtitle>
          <span className="text-white">$14.28</span>
        </AppScreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
          <div className="space-y-4">
            {[
              { label: 'Number of times ordered', value: '17' },
              {
                label: 'Current rewards balance',
                value: (
                  <div className="flex">
                    $34.28
              ...
              { label: 'Recurring weekly at 9am', value: 'Yes' },
            ].map((item) => (
              <div
                key={item.label}
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Get your favorite food and coffee ahead of time.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            Deliveroo was built for busy students who want to get their meals
            delivered to them from their favorite campus restaurants and cafes.
          </p>
        </div>
      </Container>
