      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-gray-500">Deliveroo</div>
            <div className="text-sm text-gray-900">Delivery earnings</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                ...
                <div className="font-medium text-gray-900">$738</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">This Month</div>
                <div className="font-medium text-gray-900">$997</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Deliveroo is a food delivery service that allows you to order food
              from your favourite restaurants and have it delivered to your
              door. For college students and professors alike!
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <Button href="/feedback" className="hidden lg:block">
          ...
          <div className="relative -mt-4 mb-20 lg:col-span-7 lg:mt-0 xl:col-span-6"></div>
        </div>
      </Container>
    </div>
  )
